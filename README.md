...
Runs purely on Python 3. Requires a copy of the Plato, which you can ask for permission from @horsfielda, before contacting me for a Plato binary and install script (or you can instead install Plato manually).
